...
public class OrganizationsServiceTests
{
    ...
    public async Task CreateOrganizationAsync_ShouldAddOrganization()
    {
        ...
        _unitOfWorkMock.Setup(u => u.OrganizationRepository.Add(organization, _cancellationToken));
        ...
        // Assert
        _unitOfWorkMock.Verify(u => u.OrganizationRepository.Add(organization, _cancellationToken), Times.Once);
    ...
    public async Task SearchOrganizationsAsync_ShouldReturnOrganizations()
    {
        ...
        _unitOfWorkMock.Setup(u => u.OrganizationRepository.Search(searchParams, _cancellationToken))
        ...
        _unitOfWorkMock.Verify(
            u => u.OrganizationRepository.Search(searchParams, _cancellationToken),
            Times.Once);
    }
